  ...
  if (error) {
    return (
      <Box sx={{
        ...
        <Typography color="var(--text-secondary)" variant="h6" align="center" mb={3}>{error}</Typography>
        <Button
          variant="contained"
          onClick={handleBack}
          sx={{
  ...
  if (!helperData) {
    return (
      <Box sx={{
        ...
        <Typography color="var(--text-secondary)" variant="h6" align="center">No helper data found</Typography>
      </Box>
    );
  }
      ...
      <Box className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <IconButton
            ...
            sx={{ color: 'var(--text-primary)', ml: 2 }}
            title="Refresh"
          >
            <RefreshIcon />
          </IconButton>
            ...
            <Grid container spacing={{ xs: 1.5, sm: 2, md: 3 }}>
              <Grid item xs={12} md={12}>
                <Paper sx={{
                  ...
                  <Typography variant="body2" color="var(--text-secondary)">Total Bookings</Typography>
          ...
          <Table stickyHeader size="small">
            ...
            <TableBody>
              {filteredServicesByMonth.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={13} align="center" sx={{ color: 'var(--text-primary)', py: 3 }}>
                ...
                Array.from(
                  ...
                  return (
                    <TableRow
                      key={serviceName}
                      sx={{
                        '&:nth-of-type(odd)': { backgroundColor: 'var(--surface-secondary)' }
                      }}
                    >
                      <TableCell
                        sx={{
          ...
          <Table stickyHeader>
            ...
            <TableBody>
              {paginatedBookings.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={5} align="center" sx={{ color: 'var(--text-primary)', py: 4 }}>
                    No bookings found
                  </TableCell>
                </TableRow>
              ) : (
                paginatedBookings.map((booking, index) => (
                  ...
                  >
                    <TableCell sx={{ color: 'var(--text-primary)', borderBottom: '1px solid var(--surface-secondary)' }}>
                      <Typography sx={{ color: 'var(--primary)', fontWeight: 'medium' }}>
                        {booking.serviceName}
                      </Typography>
